                    ...
                    <div class="group flex flex-col bg-white border shadow-md rounded-xl">
                        <div class="p-3 md:p-4">
                            <div class="flex justify-between items-center">
                                <div>
                                    <button
                                        class="group-hover:text-blue-600 font-bold text-[#000]" data-hs-overlay="#modalItem{{$item->id}}">
                                        {{$item->name}}
                                    </button>
                                        ...
                                        <div class="relative flex flex-col bg-white shadow-lg rounded-xl ">
                                            <div class="absolute top-2 right-2 z-[10]">
                                                <button type="button"
                                                    ...
                                                    data-hs-overlay="#modalItem{{$item->id}}">
                                            ...
                                            <div class="p-4 sm:p-10 overflow-y-auto">
                                                ...
                                                <div class="mt-6 flex justify-center gap-x-4">
                                                    <button class="py-2.5 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold text-blue-500 hover:text-blue-700 focus:outline-none focus:ring-2 ring-offset-white focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm" data-hs-overlay="#modalItem{{$item->id}}">
                                                        Close
                                                    </button>
                                                    <button type="button"
                                                        class="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-[#f9a109] text-gray-700 shadow-sm align-middle hover:bg-[#d28707] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm" onclick="addToCart({{$item}})">
                                                        Add to list
                                                    </button>
                                                </div>
                                            </div>
