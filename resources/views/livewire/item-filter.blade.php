                                        ...
                                        <div class="relative flex flex-col bg-white shadow-lg rounded-xl ">
                                            <div class="absolute top-2 right-2 z-[10]">
                                                <button type="button"
                                                    ...
                                                    <svg class="w-3 h-3" width="8" height="8" viewBox="0 0 8 8"
                                            ...
                                            <div class="aspect-w-16 aspect-h-8">
                                                <img class="w-full object-cover rounded-t-xl" src="{{$item->image}}"
...
<script>
    function addToCart(item) {
        ...
        var existingItem = cartList.querySelector('input[value="' + item.name + '"]');
        if (existingItem) {
